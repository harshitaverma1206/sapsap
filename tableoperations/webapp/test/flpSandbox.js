					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tableoperations-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"tableoperations-display": {
								"semanticObject": "tableoperations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tableoperations",
									"url": sap.ui.require.toUrl("tableoperations")
								}
							}
						}
					}
